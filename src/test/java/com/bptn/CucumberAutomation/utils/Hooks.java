...
public class Hooks {
 ...
 @Before("@StrongPasswordValidation")
 public void beforeExampleScenario(Scenario scenario) {
     // Add your setup code specific to the ExampleScenario tag
     System.out.println("Before Strong Password Validation Scenario: " + scenario.getName());
 }

 @After("@StrongPasswordValidation")
 public void afterExampleScenario(Scenario scenario) {
     // Add your cleanup code specific to the ExampleScenario tag
     System.out.println("After Strong Password Validation Scenario: " + scenario.getName());
 }
